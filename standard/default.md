...
7.4.5. 在分页文档中，目录范围应从前言开始到文档最后，目录范围内计算页码。

7.4.6. 在分页文档中，目录总是从新页开始。
...
7.7.2. 同一个父标题下的次级内容，应采用相同的表述形式，要么同为标题，要么同为段落。
...
7.7.4. 属于正文的要素统一进行多级编号。

7.7.5. 多级编号从 "1." 开始，形式参考 B.1。

7.7.6. 在分页文档中，正文总是从新页开始。

### 7.8. 范围 Scope

7.8.1. 用来给出本文档内容的边界和本文档的适用范围。
...
7.13.2. 同一个父标题下的次级内容，应采用相同的表述形式，要么同为标题，要么同为段落。

7.13.3. 一个文档可以有多个附录，所有附录统一进行多级编号。

7.13.4. 标题内容的格式为 “附录 <编号字母>（<附录性质>）<附录名称>”。

7.13.5. 编号字母从 “A” 开始。

7.13.6. 附录性质为“规范性”或“资料性”。

7.13.7. 标题级别为 2 级。

7.13.8. 附录可以展开内容，也可以引用电子文件或其他文档。

7.13.9. 附录按表述需要使用所有可用形式。

7.13.10. 标题、子标题、段落都进行多级编号。

7.13.11. 附录多级编号的第一节是编号字母，其他为数字，形式参考 B.2。

7.13.12. 在分页文档中，附录总是从新页开始。
...
8.1.2. 1 级和 2 级标题宜居中显示。

8.1.3. 3 级和 3 级以下标题应左对齐。

8.1.4. 图、表格、示例应安置在多级编号段落中。
...
8.4.2. 成对出现的标点符号，如果其标记的内容全是英文，应使用半角英文标点符号。
