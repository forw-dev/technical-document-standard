...
属于正文的要素统一进行多级编号，多级编号从 "1." 开始，形式参考 B.1。
...
标题内容固定为“术语和定义”，级别为 2 级，无 3 级以下子标题。
...
### 核心表述 Core Expression

描述为达到编制目的所必须的表述。

按表述需要决定标题内容，标题级别为 2 级。
