...
m. **只提要求**。以规范结果为目的，只提要求，不解释。
m. **无歧义**。消除歧义最重要，优先于美观、简练、优雅等。  
m. **结构化**。用形式传递信息，便于阅读，便于理解，便于抓住重点。  
m. **自洽**。形式自洽、内容自洽、内涵自洽。  
m. **方便使用**。面向行动，站在使用者的角度思考，阅后能行动。  
m. **方便沟通时引用**。方便语音、文字等方式沟通时，进行精确的局部、全部引用。  
m. **方便其他文档引用**。为建立宏大体系提供可能。  
m. **方便管理**。方便编写、修改、收发、维护等工作的进行。  
m. **方便知识化**。方便内容归档、方便机器检索、采集。  
m. **方便呈现、保存**。方便以在线、电子文件、纸质打印件等多种方式呈现、保存。
...
m. 用来给出本文档内容的边界和本文档的适用范围。
m. 描述内容边界时，表述形式为“本文档描述了……。本文档没有描述……。”。
m. 描述适用范围时，表述形式为“本文档适用于……。本文档不适用于……。”。

### 规范性引用 Normative References

m. 用来给出本文档所依赖的其他文档以及具体部分。  
m. 第一个段落为引导语，内容应固定为 “下列文档是本文档的组成部分。凡是注日期的引用文档，仅注日期的版本适用于本文档。凡是不注日期的引用文档，其最新版本（包括所有的修改单）适用于本文档。”。  
m. 引导语之后为无序列表。  
m. 一个引用一个列表项。
...
m. 用来明确文档中所使用的概念。  
m. 如果引用其他文档的术语和定义，表述形式为“ XXX 界定的术语和定义适用于本文档。”。  
m. 如果自己界定术语和定义，应用引导语引出，引导语固定为“下列术语和定义（也）适用于本文档。”。  
m. 自己界定术语和定义时，术语应提供相应的英文翻译词。  
m. 自己界定术语和定义时，术语及其对应的英文为 3 级标题。  
m. 自己界定术语和定义时，术语定义的表述形式为段落。

### 符号和缩略语 Symbols and Abbreviations

m. 用来给出文档中使用的符号、缩略语的说明。  
m. 符号为无序列表形式。  
m. 符号列表用引导语引出，引导语固定为“下列符号适用于本文档。”。  
m. 一个符号及其说明为一个列表项。  
m. 符号与其说明用冒号分开。  
m. 缩略语为无序列表形式。  
m. 缩略语列表用引导语引出，引导语固定为“下列缩略语适用于本文档。”。  
m. 一个缩略语及其说明为一个列表项。  
m. 缩略语与其说明用冒号分开。

### 总则

m. 描述起草具体技术文档的过程中，面对选择时，总的决策原则、决策倾向、决策理念、决策方法。  
m. 按表述需要使用所有可用形式。

### 系统构成

m. 描述所涉及系统的全貌、组成部分、组成部分的关系、运行机制。  
m. 按表述需要使用所有可用形式。
...
m. 当前言、正文中某些内容过长时，可以将细节移出，形成附录。  
m. 一个文档可以有多个附录。  
m. 附录的标题和段落进行多级编号。  
m. 附录中 2 级标题的编号格式为 “附录 <编号字母>（<附录性质>）<附录名称>”。  
m. 附录的编号字母从 “A” 开始。
m. 附录性质为“规范性”或“资料性”。  
m. 附录内容多级编号的第一节是编号字母，其他为数字。  
m. 多级编号的方法见 B.2。  
m. 按表述需要使用所有可用形式。  
m. 附录可以展开内容，也可以引用电子文件或其他文档。  
m. 在类纸文档中，附录总是从新页开始。
...
m. 2 级标题宜居中显示。  
m. 3 级和 3 级以下标题应左对齐。  
m. 图、表格、示例应安置在多级编号段落中。
m. 段落不应首行缩进。
m. 段落与段落之间应空一行的距离。

### 语言

m. 统一用助动词“应”、“不应”表达约束程度。
...
m. 文本中的英文字符、阿拉伯数字应使用半角字符。  
m. 中文字符与英文字符之间，应有一个半角空格。  
...
m. 除另有规定外，文本中的标点符号应使用全角中文标点符号。  
m. 成对出现的标点符号，如果其标记的内容全是英文，应使用半角英文标点符号。
...
m. 应采用全角浪纹号（～）表示范围，前值和后值的单位、量级、百分号、千分号都不应省略。
